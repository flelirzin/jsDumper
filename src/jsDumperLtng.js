(function(wdw){
			...
			var jsDumper = function( o, op ) {
				...
				var doSeqNext = function() {
					doui++; 
					return doui; 
				}
				
				var doSeqCurrent = function() {
					return doui; 
				}
				

				var sortedKeys = function( ls ) {
					var tl = [];
				...
				var recDumpObj = function( o, lvs, lvn, bk ) {
					mxlnct--; 
